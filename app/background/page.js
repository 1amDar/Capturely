            ...
            <div className="h-56 overflow-y-auto pr-2 mb-4">
              ...
              {activeTab === "extras" && (
                <div className="space-y-3">
                  {/* Date format options */}
                  <div>
                    <h3 className="text-sm font-bold mb-2 text-gray-800">Font Color</h3>
                  ...
                  {/* Font Color Picker */}
                  <div>
                    <h3 className="text-sm font-bold mb-2 text-gray-800">Date Format</h3>
                    ...
                    <div className="mt-2 flex flex-wrap gap-1.5">
                     ...
                     {/* Booth Name Input */}
                        <div className="w-full">
                          <h3 className="text-sm font-bold mb-2 text-gray-800">Title</h3>
                          <div className="flex w-full">
                            <input
                              type="text"
                              value={boothName}
                              onChange={(e) => setBoothName(e.target.value)}
                              placeholder="Photobooth Name here"
                              className="
                                flex-1
                                min-w-0
                                px-3 py-2
            ...
            >
              ...
              <div className="flex flex-col w-full" style={{ gap: `${stripGap}px` }}>
                ...
                {(boothName || showDate) && (
                  ...
                  >
                    {boothName && <div>{boothName}</div>}
                    {showDate && <div>{dateFormats[dateFormat]}</div>}
                  </div>
                )}
              </div>
            </div>
